    ...
    describe 'POST #create' do
        ...
        context 'for existed users' do
            ...
            context 'with valid data' do
                let(:request) { post '/api/v1/tasks', params: { task: { to: 'ru', file: File.open("#{Rails.root}/config/locales/en.yml") }, email: user.email, access_token: user.access_token, format: :json } }
            ...
            context 'with invalid data' do
                let(:request) { post '/api/v1/tasks', params: { task: { to: '', file: File.open("#{Rails.root}/config/locales/en.yml") }, email: user.email, access_token: user.access_token, format: :json } }
