...
ActiveRecord::Schema.define(version: 2018_05_14_031544) do
  ...
  create_table "positions", force: :cascade do |t|
    ...
    t.text "phrases_value", default: "", null: false
  ...
  create_table "words", id: :serial, force: :cascade do |t|
    ...
    t.index ["text", "locale_id"], name: "index_words_on_text_and_locale_id", unique: true
  end
